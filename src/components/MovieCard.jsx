              ...
              <div className="group p-5 grid z-10">
                ...
                <div className="h-20">
                  <span className="line-clamp-3 py-2 h-20 leading-6 text-sm font-light leading-relaxed">
                    ...
                    encounters a team of Spider-People charged with protecting
                    its very existence. When the heroes clash on how to handle a
                    new threat, Miles must redefine what it means to be a hero.
                  </span>
                </div>
                <div className=" grid-cols-2 flex group justify-between">
                  <div className="font-black flex flex-col">
                    <span className="text-yellow-500 text-xl">{Type.to}</span>
